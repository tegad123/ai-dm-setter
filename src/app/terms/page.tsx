    ...
    <div className='mx-auto max-w-3xl px-6 py-12'>
      ...
      <div className='space-y-6 text-sm leading-relaxed'>
        <section>
          ...
          <p>
            By using Convlo, you agree to these Terms of Service. If you do not
        ...
        <section>
          ...
          <p>
            Convlo is an AI-powered messaging platform that helps businesses
        ...
        <section>
          ...
          <p>
            ...
            Instagram account to Convlo.
          </p>
        </section>

        <section>
          <h2 className='mb-2 text-xl font-semibold'>4. Acceptable Use</h2>
          <p>You agree not to use Convlo to:</p>
        ...
        <section>
          ...
          <p>
            ...
            reviewing and approving messages sent through the platform. Convlo
        ...
        <section>
          ...
          <p>
            Convlo is provided &quot;as is&quot; without warranties of any kind.
