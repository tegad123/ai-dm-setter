...
CREATE TABLE "BridgingMessageTemplate" (
  "id" TEXT NOT NULL,
  "accountId" TEXT,
  "scriptId" TEXT,
...
CREATE INDEX "BridgingMessageTemplate_accountId_currentStepKey_skippedAheadStepKey_idx"
  ON "BridgingMessageTemplate"("accountId", "currentStepKey", "skippedAheadStepKey");

CREATE INDEX "BridgingMessageTemplate_scriptId_currentStepKey_skippedAheadStepKey_idx"
  ON "BridgingMessageTemplate"("scriptId", "currentStepKey", "skippedAheadStepKey");

CREATE INDEX "BridgingMessageTemplate_currentStepKey_skippedAheadStepKey_isActive_idx"
