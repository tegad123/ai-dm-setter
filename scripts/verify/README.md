...
| `scheduled-reply-terminal-outcomes.ts` | recent terminal reason coverage, timestamps, claim snapshots, and generation-trace links                                                                                                                        | P0 gate: zero unclassified new terminal outcomes                          |
